...
function Community() {
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-start items-center overflow-hidden bg-black">
      ...
      <div className="md:w-[70%] w-full h-full flex   justify-end p-0">
        <div
          className="md:h-[100%] h-full  bg-opacity-40 border border-red-100  border-opacity-25 border-y-black  w-full md:w-[750px] overflow-y-scroll flex flex-col justify-start items-center md:p-4 p-1"
